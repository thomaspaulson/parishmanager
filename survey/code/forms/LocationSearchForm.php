...
class LocationSearchForm extends BaseForm
{
    ...
    public function getFormFields() {
        ...
        $fields->push(CheckboxField::create('IsPanchayat', 'In Panchayat'));
        $fields->push(CheckboxField::create('IsMunicipality', 'In Municipality'));
        $fields->push(CheckboxField::create('IsCorporation', 'In Corporation'));
