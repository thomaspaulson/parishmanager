 ...
 * Time: 5:42 PM
 */
class GroupsSearchForm extends BaseForm
{
    ...
    public function getFormFields() {
        ...
        $groups = CommunityGroup::get()->map('ID', 'Title')->toArray();
        $groupField = DropdownField::create('Group', 'Group')
            ->setSource($groups);
        $groupField->setEmptyString('Select');        
